...
UTILS="vim gedit curl git vlc pavucontrol alacarte gnome-tweak-tool net-tools xbacklight playerctl pactl keepassxc rofi scrot gpicview redshift-gtk flameshot"
